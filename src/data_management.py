...
def download_genome_and_reference(
    genome_id: str, output_dir: str = None, email: str = NCBI_EMAIL
) -> Tuple[str, str]:
...
def print_dna_sequence(
    genome_seq: str, start: int, end: int, line_width: int = 60, full: bool = False
):
...
def download_all_test_genomes(
    output_dir: str = None, email: str = NCBI_EMAIL
